                ...
                >
                    <div class="ambient-control-row">
                        ...
                        >
                            ...
                            <option value="pink-noise">{t!(i18n, settings.notifications.ambient_track_pink_noise)}</option>
                            <option value="brown-noise">{t!(i18n, settings.notifications.ambient_track_brown_noise)}</option>
                            <option value="binaural">{t!(i18n, settings.notifications.ambient_track_binaural)}</option>
                        </select>
                    </div>
                    <div class="ambient-control-row">
